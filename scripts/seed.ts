...
const mockMembers = [
    ...
    },
    {
        ...
        fname: 'Michael',
        lname: 'Scott',
        status_notes: 'Regional Manager. Family Plan Primary (Account #FM-900). Needs constant validation.',
        tags: ['corporate', 'family-primary', 'manager'],
        location_id: 'GYM_109',
    ...
    },
    {
        ...
        fname: 'Holly',
        lname: 'Scott',
        status_notes: 'Family Plan Dependent (Account #FM-900). HR Representative.',
        tags: ['family-dependent', 'active'],
        location_id: 'GYM_109',
        enrollment_date: '2011-03-15',
        monthly_visits: 6,
        created_at: '2011-03-15T00:00:00Z',
        updated_at: '2025-12-15T00:00:00Z',
    },
    {
        member_id: 'mem-018',
        email: 'creed.bratton@quality.gov',
        fname: 'Creed',
        lname: 'Bratton',
        status_notes: 'Medical Freeze effective 2025-11-01. Do not contact regarding payment.',
        tags: ['frozen', 'medical-leave'],
        location_id: 'GYM_109',
        enrollment_date: '1999-12-31',
        monthly_visits: 0,
    ...
    {
        member_id: 'mem-019',
        email: 'toby.flenderson@costarica.net',
        fname: 'Toby',
        lname: 'Flenderson',
        status_notes: 'Churned - Relocated to Costa Rica. DO NOT RE-ENGAGE.',
        tags: ['churned', 'relocated', 'do-not-contact'],
        location_id: 'GYM_109',
        enrollment_date: '2008-05-20',
        monthly_visits: 0,
        created_at: '2008-05-20T00:00:00Z',
        updated_at: '2025-10-01T00:00:00Z',
    },
    {
        member_id: 'mem-020',
        email: 'ryan.howard@temp.com',
        fname: 'Ryan',
        lname: 'Howard',
        status_notes: 'Business Traveler. Accesses multiple locations (GYM_109, GYM_110).',
...
const mockLocations = [
    ...
    {
        location_id: 'GYM_109',
        metadata: { name: 'Scranton Business Park Gym', region: 'Northeast', market_segment: 'Corporate' },
        staffing: { coordinator_id: 'STF_107', coordinator_name: 'Dwight Schrute', coordinator_tenure_days: 3650 },
        contract_logic: { rate_model: 'corporate_bulk', base_rate: 10.00, conversion_bonus_enabled: false },
        operational_rules: { opening_hour: '05:00', closing_hour: '20:00', is_24_7: false, max_capacity: 150, utilization_rate: 0.95, monthly_revenue: 35000 },
        status_events: [{ date: '2025-01-01', event: 'SECURITY_UPDATE', detail: 'Keycard access only' }],
    },
    {
        location_id: 'GYM_110',
        metadata: { name: 'Executive Suites', region: 'Northeast', market_segment: 'Luxury' },
        staffing: { coordinator_id: 'STF_108', coordinator_name: 'Jan Levinson', coordinator_tenure_days: 60 },
        contract_logic: { rate_model: 'premium_surcharge', base_rate: 150.00, conversion_bonus_enabled: true },
        operational_rules: { opening_hour: '00:00', closing_hour: '23:59', is_24_7: true, max_capacity: 50, utilization_rate: 0.40, monthly_revenue: 75000 },
        status_events: [{ date: '2025-12-01', event: 'GRAND_OPENING', detail: 'Soft launch complete' }],
    },
];
